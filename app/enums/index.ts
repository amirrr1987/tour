...
export const findTourLevelType = (e: TourLevelTypeEnum) => {
  const index = findIndex(TourLevelTypeEnumList, (val: { value: TourLevelTypeEnum; }) => val.value == e);
...
export const findTourType = (e: TourTypeEnum) => {
  const index = findIndex(TourTypeEnumList, (val: { value: TourTypeEnum; }) => val.value == e);
  if (index < 0) return {} as Item;
...
export const findMealType = (e: MealTypeEnum) => {
  const index = findIndex(MealTypeEnumList, (val: { value: MealTypeEnum; }) => val.value == e);
  if (index < 0) return {} as Item;
...
export const findTransferType = (e: TransferTypeEnum) => {
  const index = findIndex(TransferTypeEnumList, (val: { value: TransferTypeEnum; }) => val.value == e);
  if (index < 0) return {} as Item;
...
export const findStayType = (e: StayTypeEnum) => {
  const index = findIndex(StayTypeEnumList, (val: { value: StayTypeEnum; }) => val.value == e);
  if (index < 0) return {} as Item;
